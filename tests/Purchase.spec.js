...
const data=require('../utils/productdetails.json');
 ...
 /* ************** TEST 1: ******************************************************* */
   // Below Test is for adding the product to the cart 
    ...
    test('Selecting and adding product to cart',async({page})=>
    {
...
/* ************** TEST 2: ******************************************************* */
  ...
  test('Add product under phone category and pass till purchase',async({page})=>
{
...
test('Add product under monitors category and do till purchase',async({page})=>
{
    test.setTimeout(60000);
